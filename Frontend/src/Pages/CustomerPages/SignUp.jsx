            ...
            try {
                ...
                if(password){
                    if(password.length<6){
                        setValidPassword("password's lenght must be 6 or more")
                    }
                }else{
                    return setValidPassword("password is required")
                }

               const response = await axios.post('http://localhost:4000/book_publisher/auth/signup',{
                email,password
               });
        ...
        <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-12">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Create your account with your email and password</p>
                </div>
                <div className="lg:w-1/2 md:w-2/3 mx-auto">
                    <div className="flex items-center flex-col -m-2">
                        ...
                        <div className="p-2 w-full">
                            <button onClick={handleSignup} className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Sign Up</button>
                        </div>
                        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                            <div>
                                Do you have already account? <Link to='/login'  classNameName="text-indigo-500">Sign In</Link>
                            </div>
